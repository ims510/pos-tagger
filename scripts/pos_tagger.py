...
parser.add_argument("-i", "--input-file", type=str, default="../data/raw/CLEAN_csv_planification.tsv", help="Chemin du fichier csv d'entrée")
parser.add_argument("-o", "--output-file", type=str, default="../data/clean/annotation_erreurs_treetagger.csv", help="Chemin du fichier csv de sortie")
...
print(f"Les données ont bien été sauvegardées dans le fichier {args.output_file}.")